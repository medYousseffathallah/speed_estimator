"""
Isolated v5 tracking components.
"""
...
from speed_estimation import Detection, TrackerInput, TrackerOutput, TrackState
...
class GreedyIoUTracker:
    """Simple IoU-based tracker using greedy matching."""
    ...
    def update(self, inp: TrackerInput) -> TrackerOutput:
        ...
        # Compute cost matrix and perform matching
        ...
        # Return confirmed tracks (min_hits and updated this frame)
        out_tracks = [
            ts
